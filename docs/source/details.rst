[cybersecuritywithprivategpt-d23c] Details
============================
...
.. list-table::
   ...
   * - **User Parameter**
     - **Chosen Value**
   * - solutionname
     - cybersecuritywithprivategpt-d23c
   * - solutiontitle
     - My Solution Title
   * - solutiondescription
...
.. list-table::
   ...
   * - jsoncriteria
     - uid=hostName,filter:allrecords~subtopics=hostName,hostName,hostName~values=inboundpackets,outboundpackets,pingStatus~identifiers=outboundpackets,inboundpackets~datetime=lastUpdated~msgid=~latlong=
