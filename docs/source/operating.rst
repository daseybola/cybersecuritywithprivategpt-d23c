...
Generated On: 2024-11-15 19:56:06 UTC
...
.. important::
   docker run -d -p 55693:55693 -p 42019:42019 -p 37557:37557 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-d23c \-\-env SOLUTIONDAG=solution_preprocessing_dag_mqtt-cybersecuritywithprivategpt-d23c \-\-env GITUSERNAME=daseybola  \-\-env GITREPOURL=https://github.com/daseybola/raspberrypi \-\-env SOLUTIONEXTERNALPORT=55693  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=42019  \-\-env SOLUTIONVIPERVIZPORT=37557 \-\-env DOCKERUSERNAME='abramdocker1234'  \-\-env EXTERNALPORT=46873 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='abramfas' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  abramdocker1234/cybersecuritywithprivategpt-d23c-amd64
...
.. important::
   solution_preprocessing_dag_mqtt-cybersecuritywithprivategpt-d23c
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=55693, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42355, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33541, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33013, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=35123, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46069, HPDEHOST=127.0.1.1, HPDEPORT=40449, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40381

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9845-cybersecuritywithprivategpt-d23c,solution_preprocessing_dag_mqtt-cybersecuritywithprivategpt-d23c, python-preprocess-3073-cybersecuritywithprivategpt-d23c,solution_preprocessing_dag_mqtt-cybersecuritywithprivategpt-d23c, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
