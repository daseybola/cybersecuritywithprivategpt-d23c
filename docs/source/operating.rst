[cybersecuritywithprivategpt-d23c] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-d23c] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-d23c] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/daseybola/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/daseybola/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=36715  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='daseybola'  \-\-env DOCKERUSERNAME='abramdocker1234'  \-\-env MQTTUSERNAME='abramfas'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   abramdocker1234/cybersecuritywithprivategpt-d23c-amd64 (https://hub.docker.com/r/abramdocker1234/cybersecuritywithprivategpt-d23c-amd64)
...
.. important::
   docker run -d -p 40211:40211 -p 32985:32985 -p 60237:60237 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-d23c \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-d23c \-\-env GITUSERNAME=daseybola  \-\-env GITREPOURL=https://github.com/daseybola/raspberrypi \-\-env SOLUTIONEXTERNALPORT=40211  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=32985  \-\-env SOLUTIONVIPERVIZPORT=60237 \-\-env DOCKERUSERNAME='abramdocker1234' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=36715 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='abramfas' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  abramdocker1234/cybersecuritywithprivategpt-d23c-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=60237
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=40211
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - abramdocker1234/cybersecuritywithprivategpt-d23c-amd64
...
It can be accessed by entering: http://localhost:32985
...
.. important::
   http://localhost:60237/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:60237/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:60237/<html file>
...
[cybersecuritywithprivategpt-d23c] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/daseybola/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-d23c
...
.. important::
   https://cybersecuritywithprivategpt-d23c.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-d23c
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=40211, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42777, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41303, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40057, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36743, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38935, HPDEHOST=127.0.1.1, HPDEPORT=45837, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37001
